...
description: Anti-AI-generic design guidelines — rules for making designs that look real, not AI-generated
allowed_tools:
  - Read
  - Glob
  - Grep
...
## Rule 6: Self-Check Before Review
...
## Rule 7: Critic Review Checklist
...
## Rule 8: When Design and Implementation Don't Match
