...
A 4-stage pipeline from idea to investor-ready materials. Each stage has a gate — don't skip ahead.
...
| Agent | Role |
|---|---|
| `research-planner` | Plans research before doing it |
| `idea-killer` | Finds every flaw in your idea |
...
- Be a brutal, honest startup advisor. No sugarcoating.
