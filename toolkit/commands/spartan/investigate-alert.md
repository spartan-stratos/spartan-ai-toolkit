---
name: spartan:investigate-alert
...
### Load Skill
Read and follow `skills/investigate-alert/SKILL.md` — it contains the complete investigation process.
...
2. Suggest `/spartan:oncall-log` if relevant for on-call context
