...
PACK_DEPENDS_core=""
PACK_COMMANDS_core="spec plan build debug onboard daily context-save update pr-ready init-project init-rules scan-rules lint-rules careful freeze unfreeze guard sessions contribute gate-review"
...
PACK_COMMANDS_frontend_react="next-app next-feature fe-review figma-to-code e2e qa"
...
PACK_DEPENDS_ops=""
PACK_COMMANDS_ops="deploy env-setup investigate-alert oncall-log"
PACK_RULES_ops=""
PACK_SKILLS_ops="investigate-alert oncall-log"
PACK_AGENTS_ops=""
