...
PACK_DEPENDS_core=""
PACK_COMMANDS_core="build fix onboard quickplan daily context-save update debug pr-ready init-project careful freeze unfreeze guard"
...
PACK_COMMANDS_research="startup kickoff deep-dive full-run fundraise research pitch outreach content write"
PACK_RULES_research=""
