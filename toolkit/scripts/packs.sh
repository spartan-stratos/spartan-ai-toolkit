...
PACK_DEPENDS_core=""
PACK_COMMANDS_core="spec plan build debug onboard daily context-save magic-doc memory-consolidate update pr-ready ship-pr commit-message init-project init-rules scan-rules lint-rules careful freeze unfreeze guard sessions contribute gate-review epic brownfield"
