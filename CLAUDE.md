...
## About
Spartan AI Toolkit is an engineering discipline layer for AI coding tools. It has 54 slash commands (11 packs), 11 coding rules, 19 skills, 5 agents, 13 frameworks, and 13 templates. Native integration with Claude Code (npx, plugin, setup script). All content is standard markdown — usable with any AI coding tool (Codex, Gemini, Copilot, Cursor, etc.). Includes a Telegram bridge for remote session control.
